package ru.practicum.event.dal.specifications;
...
public class EventSpecifications {
    ...
    public static Specification<Event> eventAdminSearchParamSpec(EventAdminSearchParam params) {
        return userIdIs(params.getUsers())
                .and(states(params.getStates()))
    ...
    public static Specification<Event> eventPublicSearchParamSpec(PublicEventSearchParam params) {
        return userIdIs(params.getUsers())
                .and(textInAnnotationOrDescription(params.getText()))
                .and(categories(params.getCategories()))
